...
<section class="hero" style="padding-bottom:60px;">
  <div class="container">
    <h1 style="font-size:34px;"><?= h(get_setting('services_title', 'Our Services')) ?></h1>
    <p class="lead"><?= h(get_setting('services_lead', 'Flexible shipping options for every kind of package, budget and deadline.')) ?></p>
  </div>
</section>
  ...
  <div class="container">
    <div class="grid-3">
      <div class="card">
        ...
        <h3><?= h(get_setting('services_card1_title', 'Priority')) ?></h3>
        <p><?= h(get_setting('services_card1_desc', 'Our fastest service for time-critical shipments, with premium handling and priority routing at every hub.')) ?></p>
      </div>
      <div class="card">
      ...
      <div class="card">
        ...
        <h3><?= h(get_setting('services_card3_title', 'Standard')) ?></h3>
        <p><?= h(get_setting('services_card3_desc', 'Cost-effective shipping for everyday parcels, with the same live tracking and email alerts.')) ?></p>
      </div>
    </div>
  </div>
</section>
